...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      strong('Introduction'),
      p('This is the Shiny app for next word prediction for the Johns Hopkins Data Science Capstone Project'),
      p("The app owes a debt of thanks to the Team at Quanteda.io, Amber Wang and the entire Stack Overflow community"),
      strong('Instructions'),
      p('The inputs are as follows'),
      tags$ul(
        tags$li('Query word/phrase: Initial word or phrase for prediction'),
